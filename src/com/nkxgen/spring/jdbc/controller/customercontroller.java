...
public class customercontroller {
	...
	public String customers(Model model) {
		...
		List<Customer> customerList = customer1.getAllCustomers();
	...
	@ResponseBody
	public ResponseEntity<String> customerDataUpdation(Customer updatedCustomer) {
		// Assuming customer1 is an instance of your CustomerRepository or service
		System.out.println(updatedCustomer);
		customer1.updateCustomerDataById(updatedCustomer);
